...
Component({
  ...
  methods: {
    ...
    showResume:function(e){
      ...
      wx.navigateTo({
        url: '/pages/myResume/myResume?openid='+this.data._data.openId
      })
    },
    copy: function (e) {
    ...
    _delete:function(){
      ...
      console.log("信息发布者openid：",this.data._data.openId)
      if(this.data.openid==this.data._data.openId){
      wx.showModal({
        content: '是否删除？',
        showCancel: true,
        title: '提示',
